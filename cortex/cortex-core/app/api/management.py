...
async def system_status(current_user: Dict[str, Any] = Depends(get_current_user)) -> SystemStatus:
    """
...
async def list_users(current_user: Dict[str, Any] = Depends(get_current_user)) -> List[UserProfileResponse]:
    """
