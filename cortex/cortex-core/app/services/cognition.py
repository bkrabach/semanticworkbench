...
class CognitionService:
    ...
    def _extract_conversation_topics(self, conversation_items: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        stopwords = {"the", "a", "an", "and", "or", "but", "of", "to", "in", "is", "it", "that", "this", "for", "with"}
        ...
        return {
            "keywords": [{"word": word, "count": count} for word, count in topics],
    ...
    def _analyze_conversation_sentiment(self, conversation_items: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        positive_words = {"good", "great", "excellent", "amazing", "awesome", "fantastic", "wonderful", "happy", "like", "love"}
        negative_words = {"bad", "terrible", "awful", "horrible", "disappointing", "sad", "hate", "dislike", "wrong", "problem"}
