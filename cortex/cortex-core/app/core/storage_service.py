...
class StorageService:
    ...
    def __init__(self) -> None:
        """Initialize empty storage containers for workspaces and conversations."""
        self._workspaces: Dict[str, Dict[str, Any]] = {}
        self._conversations: Dict[str, Dict[str, Any]] = {}

    # Workspace operations
    def create_workspace(
        self, name: str, description: str, owner_id: str, metadata: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def verify_workspace_access(self, workspace_id: str, user_id: str) -> Dict[str, Any]:
        ...
        if workspace.get("owner_id") != user_id:
            ...
            raise PermissionDeniedException(
                resource_id=workspace_id, message="You don't have permission to access this workspace"
            )
    ...
    def create_conversation(
        self, workspace_id: str, topic: str, owner_id: str, metadata: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def get_conversations_by_workspace(self, workspace_id: str) -> List[Dict[str, Any]]:
        ...
        """
        return [conv for conv in self._conversations.values() if conv.get("workspace_id") == workspace_id]
    ...
    def verify_conversation_access(self, conversation_id: str, user_id: str) -> Dict[str, Any]:
        ...
        if conversation.get("owner_id") != user_id:
            ...
            raise PermissionDeniedException(
                resource_id=conversation_id, message="You don't have permission to access this conversation"
            )
