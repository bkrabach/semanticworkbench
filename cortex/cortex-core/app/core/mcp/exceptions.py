...
class ToolNotFoundError(MCPError):
    ...
    def __init__(self, service_name: str, tool_name: str):
        ...
        super().__init__(message, {"service_name": service_name, "tool_name": tool_name})
...
class ResourceNotFoundError(MCPError):
    ...
    def __init__(self, service_name: str, resource_name: str):
        ...
        super().__init__(message, {"service_name": service_name, "resource_name": resource_name})
...
class ValidationError(MCPError):
    ...
    def __init__(
        self, message: str, field_errors: Optional[Dict[str, str]] = None, details: Optional[Dict[str, Any]] = None
    ):
...
class ServiceInitializationError(MCPError):
    ...
    def __init__(
        self, service_name: str, original_error: Optional[Exception] = None, details: Optional[Dict[str, Any]] = None
    ):
...
class TransportError(MCPError):
    ...
    def __init__(
        self, message: str, original_error: Optional[Exception] = None, details: Optional[Dict[str, Any]] = None
    ):
        if original_error:
            message += f": {str(original_error)}"
